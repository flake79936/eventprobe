						...
						<div class="user-form-bottom">
							<div class="box-bottom">
								...
								<div class="webEvent">
									...
									<input type="url" name="Ewebsite" pattern="https?://.+" title="URLs only" placeholder="http://www.website.com" title="correct format: http://www.website.com" id="Ewebsite" value="<?php echo $fgmembersite->SafeDisplay('Ewebsite') ?>" maxlength="500"><br>
									<span id="event_Ewebsite_errorloc" class="error"></span>
								</div>
									
								<div class="fbEvent">
									<h5 for="Efacebook">Facebook</h5>
									<input type="url" name="Efacebook" pattern="https?://www.facebook.com/.+" title="Facebook URLs only" placeholder="https://www.facebook.com/USERNAME" id="Efacebook" value="<?php echo $fgmembersite->SafeDisplay('Efacebook') ?>" maxlength="500"><br>
									<span id="event_Efacebook_errorloc" class="error"></span>
								</div>
									
								<div class="gooEvent">
									<h5 for="Egoogle">Google+</h5>
									<input type="url" name="Egoogle" pattern="https?://plus.google.com/.+" title="Google+ URLs only" placeholder="https://plus.google.com/USERNAME" id="Egoogle" value="<?php echo $fgmembersite->SafeDisplay('Egoogle') ?>" maxlength="500"><br>
