	...
	*/
	function Sanitize($str, $remove_nl = true){
		...
		if($remove_nl){
			$injections = array('/(\n+)/i', '/(\r+)/i', '/(\t+)/i', '/(%0A+)/i',
			'/(%5E+)/i', '/(%5F+)/i', '/(60%+)/i', '/(%7E+)/i',
			'/(%7F+)/i', '/(%E2%82%AC+)/i', '/(81%+)/i', '/(%E2%80%9A+)/i',
			'/(%C6%92+)/i', '/(%E2%80%9E+)/i', '/(%E2%80%A6+)/i', '/(%E2%80%A0+)/i',
			'/(%E2%80%A1+)/i', '/(%CB%86+)/i', '/(%E2%80%B0+)/i', '/(%C5%A0+)/i',
			'/(%E2%80%B9+)/i', '/(%C5%92+)/i', '/(%C5%8D+)/i', '/(%C5%BD+)/i',
			'/(%8F+)/i', '/(%C2%90+)/i', '/(%E2%80%98+)/i', '/(%E2%80%99+)/i',
			'/(%E2%80%9C+)/i', '/(%E2%80%9D+)/i', '/(%E2%80%A2+)/i', '/(%E2%80%93+)/i',
			'/(%E2%80%94+)/i', '/(%CB%9C+)/i', '/(%E2%84+)/i', '/(%C5%A1+)/i',
			'/(%E2%80+)/i', '/(%C5%93+)/i', '/(%9D+)/i', '/(%C5%BE+)/i',
			'/(%C5%B8+)/i', '/(%C2%A0+)/i', '/(%C2%A1+)/i', '/(%C2%A2+)/i',
			'/(%C2%A3+)/i', '/(%C2%A4+)/i', '/(%C2%A5+)/i', '/(%C2%A6+)/i',
			'/(%C2%A7+)/i', '/(%C2%A8+)/i', '/(%C2%A9+)/i', '/(%C2%AA+)/i',
			'/(%C2%AB+)/i', '/(%C2%AC+)/i', '/(%C2%AD+)/i', '/(%C2%AE+)/i',
			'/(%C2%AF+)/i', '/(%C2%B0+)/i', '/(%C2%B1+)/i', '/(%C2%B2+)/i',
			'/(%C2%B3+)/i', '/(%C2%B4+)/i', '/(%C2%B5+)/i', '/(%C2%B6+)/i',
			'/(%C2%B7+)/i', '/(%C2%B8+)/i', '/(%C2%B9+)/i', '/(%C2%BA+)/i',
			'/(%C2%BB+)/i', '/(%C2%BC+)/i', '/(%C2%BD+)/i', '/(%C2%BE+)/i',
			'/(%C2%BF+)/i', '/(%C3%80+)/i', '/(%C3%81+)/i', '/(%C3%82+)/i',
			'/(%C3%83+)/i', '/(%C3%84+)/i', '/(%C3%85+)/i', '/(%C3%86+)/i',
			'/(%C3%87+)/i', '/(%C3%88+)/i', '/(%C3%89+)/i', '/(%C3%8A+)/i',
			'/(%C3%8B+)/i', '/(%C3%8C+)/i', '/(%C3%8D+)/i', '/(%C3%8E+)/i',
			'/(%C3%8F+)/i', '/(%C3%90+)/i', '/(%C3%91+)/i', '/(%C3%92+)/i',
			'/(%C3%93+)/i', '/(%C3%94+)/i', '/(%C3%95+)/i', '/(%C3%96+)/i',
			'/(%C3%97+)/i', '/(%C3%98+)/i', '/(%C3%99+)/i', '/(%C3%9A+)/i',
			'/(%C3%9B+)/i', '/(%C3%9C+)/i', '/(%C3%9D+)/i', '/(%C3%9E+)/i',
			'/(%C3%9F+)/i', '/(%C3%A0+)/i', '/(%C3%A1+)/i', '/(%C3%A2+)/i',
			'/(%C3%A3+)/i', '/(%C3%A4+)/i', '/(%C3%A5+)/i', '/(%C3%A6+)/i',
			'/(%C3%A7+)/i', '/(%C3%A8+)/i', '/(%C3%A9+)/i', '/(%C3%AA+)/i',
			'/(%C3%AB+)/i', '/(%C3%AC+)/i', '/(%C3%AD+)/i', '/(%C3%AE+)/i',
			'/(%C3%AF+)/i', '/(%C3%B0+)/i', '/(%C3%B1+)/i', '/(%C3%B2+)/i',
			'/(%C3%B3+)/i', '/(%C3%B4+)/i', '/(%C3%B5+)/i', '/(%C3%B6+)/i',
			'/(%C3%B7+)/i', '/(%C3%B8+)/i', '/(%C3%B9+)/i', '/(%C3%BA+)/i',
			'/(%C3%BB+)/i', '/(%C3%BC+)/i', '/(%C3%BD+)/i', '/(%C3%BE+)/i',
			'/(%C3%BF+)/i',	'/(%0D+)/i', '/(%08+)/i', '/(%09+)/i', '/(%2D+)/i', '/(%+)/i');
