<?php
	...
	foreach ($myPost as $key => $value) {  
		...
		($get_magic_quotes_exists == true && get_magic_quotes_gpc() == 1) ? $value = urlencode(stripslashes($value)) : $value = urlencode($value);
	...
	if (strcmp ($res, "VERIFIED") == 0) {
		...
		(mysqli_query($con, $sql2)) ? echo "Your event is now Posted" : echo "Error: " . $sql . "<br>" . mysqli_error($con);
		...
		(mysqli_query($con, $sql)) ?  : echo "Error: " . $sql . "<br>" . mysqli_error($con);
